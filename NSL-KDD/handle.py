...
if __name__ == '__main__':
    # preHandle('/Users/johnson/Downloads/graduation_project/code/NSL-KDD/dataset/train-unhandled.csv','./dataset/train_handled.csv')
    # preHandle('/Users/johnson/Downloads/graduation_project/code/NSL-KDD/dataset/test-unhandled.csv', './dataset/test_handled.csv')
    preHandle_2_class('/Users/johnson/Downloads/graduation_project/code/NSL-KDD/dataset/train-unhandled.csv','./dataset/train_handled_2_class.csv')
    preHandle_2_class('/Users/johnson/Downloads/graduation_project/code/NSL-KDD/dataset/test-unhandled.csv', './dataset/test_handled_2_class.csv')